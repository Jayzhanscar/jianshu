...
from ContentApp.models import SmallText, Blog, Remark, Expert
...
class TopicAdmin(admin.ModelAdmin):
    list_display = ('topic_id', 'topic_name', 'topic_author', 'img', 'topic_article', 'topic_focus', 'topic_notice', 'create_date')


class ExpertAdmin(admin.ModelAdmin):
    list_display = (
    'id', 'name', 'img', 'introduce', 'create_date')
