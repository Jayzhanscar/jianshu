...
class Books(models.Model):
    ...
    id = models.IntegerField(primary_key=True)
    # 书本名
    name = models.CharField(max_length=30, default=None, db_column='book_name')
    # 书本标记
    tag = models.IntegerField(db_column='book_tag')
    # 章节
    page = models.IntegerField(db_column='book_page')
    # 内容
    content = models.TextField(db_column='book_content')
    # author
    author = models.CharField(max_length=40, db_column='book_author')
    # 描述图片 后台导入路径
    img = models.CharField(max_length=50, db_column='book_img')
    # 作者头像
    touxiang = models.CharField(max_length=60, db_column='book_touxiang')
    # 创建时间
    create_time = models.DateTimeField(default=timezone.now, db_column='book_create_time')
